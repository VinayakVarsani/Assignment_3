...
class IndustriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create industry" do
    assert_difference("Industry.count") do
      post industries_url, params: { industry: { email: @industry.email, name: @industry.name } }
    end
  ...
  test "should update industry" do
    patch industry_url(@industry), params: { industry: { email: @industry.email, name: @industry.name } }
